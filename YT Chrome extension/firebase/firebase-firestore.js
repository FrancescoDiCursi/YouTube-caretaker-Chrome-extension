import { _getProvider, getApp, _removeServiceInstance, SDK_VERSION, _registerComponent, registerVersion } from './firebase-app.js';
 ...
 */ (t));
    ...
    /**
     * The {@link https://www.gstatic.com/firebasejs/9.0.0/firebase-app.js#FirebaseApp} associated with this `Firestore` service
     * instance.
     */    get app() {
 ...
 *
 * @param app - The {@link https://www.gstatic.com/firebasejs/9.0.0/firebase-app.js#FirebaseApp} with which the {@link Firestore} instance will
 * be associated.
 ...
 * provided {@link https://www.gstatic.com/firebasejs/9.0.0/firebase-app.js#FirebaseApp}. If no instance exists, initializes a new
 * instance with default settings.
 *
 * @param app - The {@link https://www.gstatic.com/firebasejs/9.0.0/firebase-app.js#FirebaseApp} instance that the returned {@link Firestore}
...
}), "PUBLIC" /* PUBLIC */)), registerVersion("@firebase/firestore", "3.0.0", Sh);
